...
| OpenCode Go            | `1.18.23`                             | Official account quota plus this-Mac request-level Token history, reported estimate, calculated retail equivalent, and explicit coverage                       | passed with source-native coverage                  |
